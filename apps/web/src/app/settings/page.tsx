...
const SETTING_SECTIONS = [
  {
    ...
    Icon: MessageSquare,
    desc: "Color, título, mensaje de bienvenida, GDPR",
    badge: null,
  },
  {
    label: "AI Auto-Reply",
    href: "/settings/ai",
    Icon: Sparkles,
    desc: "Tono, contexto y respuestas automáticas con Gemini",
    badge: "Pro",
  },
  {
    ...
    Icon: Bell,
    desc: "Email cuando estás offline",
    badge: null,
  },
  {
    label: "API & Acceso",
    href: "/settings/api",
    Icon: Key,
    desc: "API key, endpoints y autenticación",
    badge: "Pro",
  },
  {
    label: "Webhooks",
    ...
    Icon: Webhook,
    desc: "Integraciones con sistemas externos",
    badge: "Pro",
  },
  {
    label: "Tags",
    href: "/settings/tags",
    Icon: Tag,
    desc: "Organización de conversaciones",
    badge: null,
  },
  {
    label: "Triggers",
    ...
    Icon: Zap,
    desc: "Automatización y acciones automáticas",
    badge: null,
  },
  {
    label: "Billing",
    ...
    Icon: CreditCard,
    desc: "Plan, suscripción y cancelación",
    badge: null,
  },
];
    ...
    Promise.all([
      ...
      .then(async ([billingRes, meRes]) => {
        ...
        if (!billingRes.ok || !meRes.ok) {
          // Error de servicio — no redirigir, mostrar página vacía
          return;
        }
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-500 mt-1">Información de tu workspace y acceso rápido a las opciones</p>
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between py-2">
            ...
            >
              {info?.isActive
                ? "Pro"
                : `Trial${info?.trialDaysLeft ? ` · ${info.trialDaysLeft}d restantes` : ""}`}
            </span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-xs px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg transition-colors font-medium whitespace-nowrap"
            >
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {s.badge && (
                  <span className="text-[9px] font-bold bg-violet-100 text-violet-600 px-1.5 py-0.5 rounded-full uppercase tracking-wide">
                    {s.badge}
                  </span>
                )}
              </div>
